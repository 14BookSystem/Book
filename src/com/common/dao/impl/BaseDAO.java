...
public class BaseDAO extends HibernateDaoSupport {
	...
	public boolean saveOrUpdate(Object entity) {
		try {
			...
			e.printStackTrace();
			log.info("saveOrUpdate " + entity.getClass().getName()
					+ " is failed!");
			return false;
		}
		return true;
	 ...
	 * @param entity
	 */
	public boolean mergeObj(Object entity) {
		try {
			this.getHibernateTemplate().merge(entity);
		} catch (Exception e) {
			e.printStackTrace();
			log.info("merge " + entity.getClass().getName() + " is failed!");
			return false;
		}
		return true;
	}
	...
	public <T> T get(Class<T> clazz, Serializable id) {
		try {
			...
			e.printStackTrace();
			log.info("get by id for " + clazz.getClass().getName()
					+ " is failed!");
		}
		return null;
	}
	...
	public <T> List<T> findAll(Class<T> clazz) {
		try {
			...
			e.printStackTrace();
			log.info("find all for " + clazz.getClass().getName()
					+ " is failed!");
		}
		return null;
	}
	...
	public <T> List<T> findByProperty(final Class<T> clazz,
		...
		try {
			...
			e.printStackTrace();
			log.info("findByProperty for " + clazz.getClass().getName()
					+ " is failed!");
		}
		return null;
	}
	 ...
	 * @return
	 */
	public List pageWithParam(final String hql, final int offset,
			final int length, Object... values) {
		try {
			List list = getHibernateTemplate().executeFind(
					new HibernateCallback() {
