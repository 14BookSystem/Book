...
<HTML>
	<HEAD>
		...
		<meta http-equiv="Refresh"
			content="1;URL=${pageContext.request.contextPath}/meetbook_jsonlist.action">
	</HEAD>
	<BODY
							...
							<DIV align=middle>
								<table width="100%" border="0">
									<tr align="left">
										...
										<font size="2" color="green"> 恭喜你，操作成功..........</font>
										<br>
										<br/>
										<br/>
										网页将在1秒钟后自动跳转到首页，如没自动跳转请点击
										<a href="${pageContext.request.contextPath}/meetbook_jsonlist.action">&nbsp;这&nbsp;里&nbsp;</a>
